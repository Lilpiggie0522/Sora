...
import com.piggie.interceptor.JwtTokenAdminInterceptor;
import com.piggie.interceptor.JwtTokenUserInterceptor;
import com.piggie.json.JacksonObjectMapper;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
        log.info("extended message converter (java object -> json)");
